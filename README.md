🌟 To-do list App
This a to-do list app that helps users to tract thier activities.
It allows users to add a task, check as complete and also delete completed tasks.

🤖 Features
Users can;
- Add new tasks
- Check as compelete, uncheck as not completed
- Delete completed task
Local Storage - the user's data of tasks get save upon addition of task, checking and deletion.
User's data get retrieved even if browser tab or browser get closed.

➿ Process
- I analysed the whole project to know how to structure it and make the UI appealing
...
https://github.com/user-attachments/assets/09568711-0e2d-46ff-a3fa-6b22636d1505
